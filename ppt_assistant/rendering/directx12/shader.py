...
float4 main(PS_INPUT input) : SV_TARGET {
    ...
    def compile_shader(
        self, source: str, entry_point: str, target: str, shader_name: str = "shader"
    ) -> bytes:
        """
...
class PipelineStateObject:
    ...
    def __init__(self, name: str, vertex_bytecode: bytes, pixel_bytecode: bytes):
        """
        Initialize PSO.
...
class ShaderManager:
    ...
    def create_pso(
        self, name: str, vs_name: str, ps_name: str
    ) -> Optional[PipelineStateObject]:
        """
