...
class GLProgram:
    ...
    def set_uniform_4f(self, name: str, x: float, y: float, 
                      z: float, w: float) -> bool:
        """Set uniform vec4."""
        return True
...
class GLVertexArray:
    ...
    def bind_vertex_buffer(self, buffer_name: str, data: bytes, 
                          stride: int) -> bool:
        """Bind vertex buffer."""
        return True
    ...
    def set_vertex_attrib(self, index: int, size: int,
                         offset: int, normalized: bool = False) -> bool:
...
class OpenGLContext:
    ...
    def create_program(self, name: str, vertex_source: str,
                      fragment_source: str) -> Optional[GLProgram]:
    ...
    def create_texture(self, name: str, width: int, height: int,
                      format: str = "RGBA") -> Optional[GLTexture]:
        """Create texture."""
    ...
    def create_framebuffer(self, name: str, width: int,
                          height: int) -> Optional[GLFramebuffer]:
        """Create framebuffer."""
