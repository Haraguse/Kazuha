...
class UIDrawer:
    ...
    def draw_rounded_rect(self, rect: Rect, corner_radius: float,
                         color: Color, filled: bool = True) -> bool:
    ...
    def draw_circle(self, center: Point2D, radius: float, 
                   color: Color, filled: bool = True,
    ...
    def draw_line(self, start: Point2D, end: Point2D, 
                 color: Color, width: float = 1.0) -> bool:
        """Draw line."""
        if not self.render_context:
            return False
    ...
    def draw_polygon(self, points: List[Point2D], color: Color,
    ...
    def draw_text(self, text: str, position: Point2D, color: Color,
    ...
    def draw_stroke(self, points: List[Point2D], color: Color,
                   width: float = 1.0, cap: StrokeCapStyle = StrokeCapStyle.ROUND,
                   join: StrokeJoinStyle = StrokeJoinStyle.ROUND) -> bool:
        """
    ...
    def draw_path(self, path_data: str, color: Color, 
                 filled: bool = True, width: float = 1.0) -> bool:
        """
    ...
    def draw_gradient_rect(self, rect: Rect, 
    ...
    def outline_rect(self, rect: Rect, color: Color, 
...
class PathBuilder:
    ...
    def curve_to(self, cp1x: float, cp1y: float, 
    ...
    def quad_curve_to(self, cpx: float, cpy: float,
                     x: float, y: float) -> 'PathBuilder':
    ...
    def arc_to(self, rx: float, ry: float, rotation: float,
