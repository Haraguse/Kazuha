...
/// <summary>
/// Specifies factory methods a <see cref="T:FluentAvalonia.UI.Controls.FAFrame" /> can use to resolve pages from
/// Types that aren't controls or from object/ViewModel instances directly
/// </summary>
public interface IFANavigationPageFactory
{
	/// <summary>
	/// Returns a user specified page based on the given type passed to <see cref="M:FluentAvalonia.UI.Controls.FAFrame.Navigate(System.Type)" />
	/// </summary>
