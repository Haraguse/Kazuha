...
public class FAPageStackEntry
{
	...
	/// <see cref="M:FluentAvalonia.UI.Controls.FAFrame.NavigateFromObject``1(``0,FluentAvalonia.UI.Navigation.FAFrameNavigationOptions)" />
	/// </summary>
	...
	public FAPageStackEntry([DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicParameterlessConstructor)] Type sourcePageType, object parameter, FANavigationTransitionInfo navigationTransitionInfo)
	{
