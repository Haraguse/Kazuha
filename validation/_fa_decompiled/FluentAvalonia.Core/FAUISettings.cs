...
public class FAUISettings
{
	...
	{
		cxDrag = Win32Interop.GetSystemMetricsWithFallback(68, (uint)Math.Round(96.0 * scaling));
		cyDrag = Win32Interop.GetSystemMetricsWithFallback(69, (uint)Math.Round(96.0 * scaling));
	}
}
