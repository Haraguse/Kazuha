...
public class RuntimeXamlLoaderDocument
{
	...
	public RuntimeXamlLoaderDocument([StringSyntax("Xml")] string xaml)
	{
		XamlStream = new MemoryStream(Encoding.UTF8.GetBytes(xaml));
	}

	public RuntimeXamlLoaderDocument(Uri? baseUri, [StringSyntax("Xml")] string xaml)
		: this(xaml)
	{
		BaseUri = baseUri;
	}

	public RuntimeXamlLoaderDocument(object? rootInstance, [StringSyntax("Xml")] string xaml)
		: this(xaml)
	{
		RootInstance = rootInstance;
	}

	public RuntimeXamlLoaderDocument(Uri? baseUri, object? rootInstance, [StringSyntax("Xml")] string xaml)
		: this(baseUri, xaml)
	{
		RootInstance = rootInstance;
	}
