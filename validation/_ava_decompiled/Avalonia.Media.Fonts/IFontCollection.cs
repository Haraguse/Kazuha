...
public interface IFontCollection : IReadOnlyList<FontFamily>, IEnumerable<FontFamily>, IEnumerable, IReadOnlyCollection<FontFamily>, IDisposable
{
	...
	/// <returns>
	///     <c>True</c>, if the <see cref="T:Avalonia.Media.Fonts.IFontCollection" /> could get the list of typefaces, <c>False</c> otherwise.
	/// </returns>
	...
	/// the method returns <see langword="false" /> and <paramref name="glyphTypeface" /> is set to <see langword="null" />.</remarks>
