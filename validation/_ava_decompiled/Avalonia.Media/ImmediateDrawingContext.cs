...
{
	private readonly struct TransformContainer(Matrix localTransform, Matrix containerTransform)
	{
		public readonly Matrix LocalTransform = localTransform;

		public readonly Matrix ContainerTransform = containerTransform;
	}
	...
	internal ImmediateDrawingContext(IDrawingContextImpl impl, bool ownsImpl)
		: this(impl, impl.Transform, ownsImpl)
	{
	}
