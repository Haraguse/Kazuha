...
public class BitmapCache : CacheMode
{
	...
	public static readonly StyledProperty<double> RenderAtScaleProperty = AvaloniaProperty.Register<BitmapCache, double>("RenderAtScale", 1.0);

	public static readonly StyledProperty<bool> SnapsToDevicePixelsProperty = AvaloniaProperty.Register<BitmapCache, bool>("SnapsToDevicePixels", defaultValue: false);

	public static readonly StyledProperty<bool> EnableClearTypeProperty = AvaloniaProperty.Register<BitmapCache, bool>("EnableClearType", defaultValue: false);
	...
	public double RenderAtScale
	{
		get
		{
			return GetValue(RenderAtScaleProperty);
		}
		set
		{
	...
	public bool EnableClearType
	{
		get
		{
			return GetValue(EnableClearTypeProperty);
		}
		set
		{
