...
{
	/// <summary>
	/// Creates a <see cref="T:Avalonia.Data.BindingExpressionBase" /> from a binding.
	/// </summary>
	...
	/// </param>
	/// <returns>
	/// A newly instantiated <see cref="T:Avalonia.Data.BindingExpressionBase" />.
	/// </returns>
	/// <remarks>
	...
	/// </remarks>
	internal abstract BindingExpressionBase CreateInstance(AvaloniaObject target, AvaloniaProperty? targetProperty, object? anchor);
}
