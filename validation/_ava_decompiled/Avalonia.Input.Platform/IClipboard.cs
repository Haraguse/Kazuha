...
public interface IClipboard
{
	...
	/// </para>
	/// <para>
	/// The <see cref="T:Avalonia.Input.IAsyncDataTransfer" /> must NOT be disposed by the caller after this call.
	...
	/// </summary>
	/// <remarks>
	/// <para>The returned <see cref="T:Avalonia.Input.IAsyncDataTransfer" /> MUST be disposed by the caller.</para>
	/// <para>
	/// Avoid storing the returned <see cref="T:Avalonia.Input.IAsyncDataTransfer" /> instance for a long time:
	...
	/// <summary>
	/// Retrieves the exact instance of a <see cref="T:Avalonia.Input.IAsyncDataTransfer" /> previously placed on the clipboard
	/// by <see cref="M:Avalonia.Input.Platform.IClipboard.SetDataAsync(Avalonia.Input.IAsyncDataTransfer)" />, if any.
	/// </summary>
	/// <returns>The data transfer object if present, null otherwise.</returns>
	/// <remarks>
	/// <para>This method cannot be used to retrieve a <see cref="T:Avalonia.Input.IAsyncDataTransfer" /> set by another process.</para>
	/// <para>This method is only supported on Windows, macOS and X11 platforms. Other platforms will always return null.</para>
	/// <para>
	/// Contrary to <see cref="M:Avalonia.Input.Platform.IClipboard.TryGetDataAsync" />, the returned <see cref="T:Avalonia.Input.IAsyncDataTransfer" /> must NOT be disposed
