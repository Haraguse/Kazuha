...
public static class DragDrop
{
	...
	/// <summary>
	/// Starts a dragging operation with the given <see cref="T:Avalonia.Input.IDataTransfer" /> and returns the applied drop effect from the target.
	...
	{
		IPlatformDragSource service = AvaloniaLocator.Current.GetService<IPlatformDragSource>();
		if (service == null)
		{
			dataTransfer.Dispose();
			return Task.FromResult(DragDropEffects.None);
		}
		return service.DoDragDropAsync(triggerEvent, dataTransfer, allowedEffects);
	}
}
