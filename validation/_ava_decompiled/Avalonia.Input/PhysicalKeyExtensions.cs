...
/// <summary>
/// Contains extension methods related to <see cref="T:Avalonia.Input.PhysicalKey" />.
/// </summary>
public static class PhysicalKeyExtensions
{
	...
	/// <returns>The key corresponding to <paramref name="physicalKey" />, or <see cref="F:Avalonia.Input.Key.None" />.</returns>
	public static Key ToQwertyKey(this PhysicalKey physicalKey)
	{
		return physicalKey switch
		{
			...
			PhysicalKey.IntlBackslash => Key.OemBackslash, 
			PhysicalKey.IntlRo => Key.OemBackslash, 
			PhysicalKey.IntlYen => Key.OemPipe, 
			PhysicalKey.A => Key.A, 
			PhysicalKey.B => Key.B, 
			PhysicalKey.C => Key.C, 
			PhysicalKey.D => Key.D, 
			...
			PhysicalKey.KanaMode => Key.HangulMode, 
			PhysicalKey.Lang1 => Key.HangulMode, 
			PhysicalKey.Lang2 => Key.KanjiMode, 
			PhysicalKey.Lang3 => Key.OemFinish, 
			PhysicalKey.Lang4 => Key.DbeHiragana, 
			PhysicalKey.Lang5 => Key.DbeSbcsChar, 
			...
			PhysicalKey.NumPadEnter => Key.Return, 
			PhysicalKey.NumPadEqual => Key.OemPlus, 
			PhysicalKey.NumPadMultiply => Key.Multiply, 
			PhysicalKey.NumPadParenLeft => Key.OemOpenBrackets, 
			PhysicalKey.NumPadParenRight => Key.OemCloseBrackets, 
			...
			PhysicalKey.PrintScreen => Key.Snapshot, 
			...
			PhysicalKey.Copy => Key.DbeHiragana, 
