...
public sealed class FindNextElementOptions
{
	...
	/// currently focused. If null, <see cref="M:Avalonia.Input.FocusManager.GetFocusedElement" /> is used.
	/// </summary>
	public IInputElement? FocusedElement { get; init; }

	/// <summary>
	/// Gets or sets the root <see cref="T:Avalonia.Input.InputElement" /> within which the search for the next
	...
	/// </para>
	/// <para>
	/// This option is only used with <see cref="F:Avalonia.Input.NavigationDirection.Up" />, <see cref="F:Avalonia.Input.NavigationDirection.Down" />,
	/// <see cref="F:Avalonia.Input.NavigationDirection.Left" />, and <see cref="F:Avalonia.Input.NavigationDirection.Right" />. It is ignored for other
	/// directions.
	/// </para>
	/// </remarks>
