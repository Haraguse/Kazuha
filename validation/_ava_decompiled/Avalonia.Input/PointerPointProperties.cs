...
public record struct PointerPointProperties
{
	...
	/// <summary>
	/// Gets whether the device's primary action (e.g. <see cref="F:Avalonia.Input.MouseButton.Left" />) was active when this input occurred.
	/// </summary>
	public bool IsLeftButtonPressed { get; }

	/// <summary>
	/// Gets whether the device's tertiary action (e.g. <see cref="F:Avalonia.Input.MouseButton.Middle" />) was active when this input occurred.
	/// </summary>
	public bool IsMiddleButtonPressed { get; }

	/// <summary>
	/// Gets whether the device's secondary action (e.g. <see cref="F:Avalonia.Input.MouseButton.Right" />) was active when this input occurred.
	/// </summary>
	public bool IsRightButtonPressed { get; }

	/// <summary>
	/// Gets whether the device's first extended action (e.g. <see cref="F:Avalonia.Input.MouseButton.XButton1" />) was active when this input occurred.
	/// </summary>
	public bool IsXButton1Pressed { get; }

	/// <summary>
	/// Gets whether the device's second extended action (e.g. <see cref="F:Avalonia.Input.MouseButton.XButton2" />) was active when this input occurred.
	/// </summary>
	...
	public PointerPointProperties(RawInputModifiers modifiers, PointerUpdateKind kind, float twist, float pressure, float xTilt, float yTilt)
		: this(modifiers, kind, twist, pressure, xTilt, yTilt, default(Rect))
	{
	}
