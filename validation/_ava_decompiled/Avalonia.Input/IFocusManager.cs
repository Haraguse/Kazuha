...
public interface IFocusManager
{
	...
	/// Must be one of <see cref="F:Avalonia.Input.NavigationDirection.Next" />, <see cref="F:Avalonia.Input.NavigationDirection.Previous" />,
	/// <see cref="F:Avalonia.Input.NavigationDirection.Left" />, <see cref="F:Avalonia.Input.NavigationDirection.Right" />,
	/// <see cref="F:Avalonia.Input.NavigationDirection.Up" /> and <see cref="F:Avalonia.Input.NavigationDirection.Down" />.
	/// </param>
