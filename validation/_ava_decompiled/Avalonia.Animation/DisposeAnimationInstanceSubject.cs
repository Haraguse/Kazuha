...
/// </summary>
internal class DisposeAnimationInstanceSubject<T>(Animator<T> animator, Animation animation, Animatable control, IClock? clock, Action? onComplete, bool shouldPauseOnInvisible) : IObserver<bool>, IDisposable
{
