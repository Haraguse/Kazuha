...
public interface IFontManagerImpl
{
	...
	/// </returns>
	bool TryMatchCharacter(int codepoint, FontStyle fontStyle, FontWeight fontWeight, FontStretch fontStretch, string? familyName, CultureInfo? culture, [NotNullWhen(true)] out IPlatformTypeface? platformTypeface);
	...
	/// </returns>
	bool TryCreateGlyphTypeface(string familyName, FontStyle style, FontWeight weight, FontStretch stretch, [NotNullWhen(true)] out IPlatformTypeface? platformTypeface);
	...
	///     <c>True</c>, if the <see cref="T:Avalonia.Platform.IFontManagerImpl" /> could create the glyph typeface, <c>False</c> otherwise.
	/// </returns>
	bool TryCreateGlyphTypeface(Stream stream, FontSimulations fontSimulations, [NotNullWhen(true)] out IPlatformTypeface? platformTypeface);
	...
	/// <returns>
	///     <c>True</c>, if the <see cref="T:Avalonia.Platform.IFontManagerImpl" /> could get the list of typefaces, <c>False</c> otherwise.
	/// </returns>
