...
internal readonly struct HorizontalHeaderTable
{
	...
	/// </summary>
	internal static OpenTypeTag Tag { get; } = OpenTypeTag.Parse("hhea");
	...
	public HorizontalHeaderTable(FontVersion version, short ascender, short descender, short lineGap, ushort advanceWidthMax, short minLeftSideBearing, short minRightSideBearing, short xMaxExtent, short caretSlopeRise, short caretSlopeRun, short caretOffset, ushort numberOfHMetrics)
	{
		Version = version;
		Ascender = ascender;
		Descender = descender;
	...
	{
		horizontalHeaderTable = default(HorizontalHeaderTable);
		...
		return TryLoad(ref reader, out horizontalHeaderTable);
	}
	...
	private static bool TryLoad(ref BigEndianBinaryReader reader, out HorizontalHeaderTable horizontalHeaderTable)
	{
		...
		horizontalHeaderTable = new HorizontalHeaderTable(version, ascender, descender, lineGap, advanceWidthMax, minLeftSideBearing, minRightSideBearing, xMaxExtent, caretSlopeRise, caretSlopeRun, caretOffset, numberOfHMetrics);
		return true;
	}
}
