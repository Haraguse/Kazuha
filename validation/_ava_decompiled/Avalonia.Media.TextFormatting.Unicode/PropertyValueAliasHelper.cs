...
internal static class PropertyValueAliasHelper
{
	...
	private static readonly Dictionary<string, LineBreakClass> s_tagToLineBreakClass = new Dictionary<string, LineBreakClass>
	{
		...
		{
			"AK",
			LineBreakClass.Aksara
		},
		{
			"AP",
			LineBreakClass.AksaraPrebase
		},
		{
			"AS",
			LineBreakClass.AksaraStart
		},
		{
			"BK",
		...
		{
			"VF",
			LineBreakClass.ViramaFinal
		},
		{
			"VI",
			LineBreakClass.Virama
		}
	};

	private static readonly Dictionary<string, WordBreakClass> s_tagToWordBreakClass = new Dictionary<string, WordBreakClass>
	{
		{
			"XX",
		...
		{
			"RI",
			WordBreakClass.RegionalIndicator
		},
		{
			"FO",
	...
	{
		if (!s_scriptToTag.TryGetValue(script, out string value))
		{
			return "Zzzz";
		}
		return value;
