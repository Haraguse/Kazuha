...
public readonly record struct Vector3D(double X, double Y, double Z)
{
	...
	{
		using SpanStringTokenizer spanStringTokenizer = new SpanStringTokenizer(s, CultureInfo.InvariantCulture, "Invalid Vector.");
		return new Vector3D(spanStringTokenizer.ReadDouble(), spanStringTokenizer.ReadDouble(), spanStringTokenizer.ReadDouble());
	}
