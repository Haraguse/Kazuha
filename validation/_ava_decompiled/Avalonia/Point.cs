...
public readonly struct Point : IEquatable<Point>
{
	...
	{
		using SpanStringTokenizer spanStringTokenizer = new SpanStringTokenizer(s, CultureInfo.InvariantCulture, "Invalid Point.");
		return new Point(spanStringTokenizer.ReadDouble(), spanStringTokenizer.ReadDouble());
	}
