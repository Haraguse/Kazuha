...
public class VisualTreeAttachmentEventArgs : EventArgs
{
	...
	/// This is guaranteed to be non-null and will be the same as <see cref="P:Avalonia.Rendering.IPresentationSource.RootVisual" />.
	/// </summary>
	...
	{
		RootVisual = presentationSource.RootVisual ?? throw new InvalidOperationException("PresentationSource must have a non-null RootVisual.");
		AttachmentPoint = attachmentPoint;
		PresentationSource = presentationSource ?? throw new ArgumentNullException("presentationSource");
	}
}
