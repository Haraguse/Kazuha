...
public static class Container
{
	...
	/// </summary>
	public static readonly AttachedProperty<ContainerSizing> SizingProperty = AvaloniaProperty.RegisterAttached<Layoutable, ContainerSizing>("Sizing", typeof(Container), ContainerSizing.Normal, inherits: false, BindingMode.OneWay, null, UpdateQueryProvider);

	internal static readonly AttachedProperty<VisualQueryProvider?> QueryProviderProperty = AvaloniaProperty.RegisterAttached<Layoutable, VisualQueryProvider>("QueryProvider", typeof(Container));
