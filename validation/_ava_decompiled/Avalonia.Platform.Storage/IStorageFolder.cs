...
public interface IStorageFolder : IStorageItem, IDisposable
{
	...
	/// <returns>
	/// A <see cref="T:Avalonia.Platform.Storage.IStorageFile" /> that provides read/write access to the file specified in <c>name</c>.
	/// </returns>
	...
	/// <param name="name">The display name</param>
	/// <returns>
	/// A <see cref="T:Avalonia.Platform.Storage.IStorageFolder" /> that represents the directory at the specified <c>name</c>. This object is returned regardless of whether a directory at the specified <c>name</c> already exists.
	/// </returns>
