...
public interface IStorageProvider
{
	...
	/// </summary>
	/// <returns><see cref="T:Avalonia.Platform.Storage.OpenFilePickerResult" /> with selected files and additional dialog information such as selected file type.</returns>
	...
	/// </summary>
	/// <returns><see cref="T:Avalonia.Platform.Storage.SaveFilePickerResult" /> with saved file and additional dialog information such as selected file type.</returns>
