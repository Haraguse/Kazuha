...
public class FilePickerSaveOptions : PickerOptions
{
	...
	/// </summary>
	/// <remarks>
	/// This value should reference one of the items in <see cref="P:Avalonia.Platform.Storage.FilePickerSaveOptions.FileTypeChoices" />.
	/// If not set, the first file type in <see cref="P:Avalonia.Platform.Storage.FilePickerSaveOptions.FileTypeChoices" /> may be selected by default.
	/// </remarks>
