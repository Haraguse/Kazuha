...
/// <summary>
/// Represents the result of the <see cref="M:Avalonia.Platform.Storage.IStorageProvider.SaveFilePickerWithResultAsync(Avalonia.Platform.Storage.FilePickerSaveOptions)" /> operation.
/// </summary>
