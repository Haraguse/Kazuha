...
public class FilePickerOpenOptions : PickerOptions
{
	...
	/// </summary>
	/// <remarks>
	/// This value should reference one of the items in <see cref="P:Avalonia.Platform.Storage.FilePickerOpenOptions.FileTypeFilter" />.
	/// If not set, the first file type in <see cref="P:Avalonia.Platform.Storage.FilePickerOpenOptions.FileTypeFilter" /> may be selected by default.
	/// </remarks>
