...
public abstract class TextLine : IDisposable
{
	...
	/// </returns>
	/// <remarks>
	/// The <see cref="P:Avalonia.Media.TextFormatting.TextLine.OverhangTrailing" /> value will be positive when the trailing drawn pixel comes before the trailing alignment point.
	/// </remarks>
