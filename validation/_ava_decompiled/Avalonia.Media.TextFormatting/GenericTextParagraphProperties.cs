...
/// <summary>
/// Generic implementation of <see cref="T:Avalonia.Media.TextFormatting.TextParagraphProperties" />.
/// </summary>
public sealed class GenericTextParagraphProperties : TextParagraphProperties
{
	...
	/// <summary>
	/// Initializes a new instance of the <see cref="T:Avalonia.Media.TextFormatting.GenericTextParagraphProperties" />.
	/// </summary>
	...
	public GenericTextParagraphProperties(TextRunProperties defaultTextRunProperties, TextAlignment textAlignment = TextAlignment.Left, TextWrapping textWrapping = TextWrapping.NoWrap, double lineHeight = 0.0, double letterSpacing = 0.0)
	{
	...
	/// <summary>
	/// Initializes a new instance of the <see cref="T:Avalonia.Media.TextFormatting.GenericTextParagraphProperties" /> with values copied from the specified <see cref="T:Avalonia.Media.TextFormatting.TextParagraphProperties" />.
	/// </summary>
	/// <param name="textParagraphProperties">The <see cref="T:Avalonia.Media.TextFormatting.TextParagraphProperties" /> to copy values from.</param>
