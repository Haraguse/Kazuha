...
public class LoggingConsoleFormatter() : ConsoleFormatter("luminalium")
{
        ...
        TextWriter textWriter)
    {
        ...
        var now = DateTimeOffset.Now
            .ToString("yyyy/MM/dd HH:mm:ss", CultureInfo.InvariantCulture).Pastel(ConsoleColor.DarkGray);
