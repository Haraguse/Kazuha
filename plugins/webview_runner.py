    ...
    themes = {
        ...
        "osu": {
            "light": {
                ...
                "--text-primary": "#4A1942",
                "--text-secondary": "#8B477A",
                "--accent-blue": "#FF66AA",
                "--divider": "rgba(255,102,170,0.12)",
                "--card-bg": "rgba(255,102,170,0.06)",
                "--card-border": "rgba(255,102,170,0.1)",
                "--item-hover": "rgba(255,102,170,0.1)",
                "--shadow-color": "rgba(120,40,100,0.1)",
                "--shadow-main": "0 6px 22px var(--shadow-color)",
                "--logo-glow": "rgba(255,102,170,0.18)",
                "--hyperos-g1": "#FFE0F0",
                "--hyperos-g2": "#F0E0FF",
                "--hyperos-g3": "#E0F0FF",
                "--hyperos-g4": "#F0FFE0",
                "--hyperos-g5": "#FFFFFF",
                "--overlay-toolbar-bg": "#FFF0F6",
                "--overlay-toolbar-border": "rgba(255,102,170,0.12)",
                "--overlay-toolbar-line": "rgba(255,102,170,0.12)",
                "--overlay-toolbar-shadow": "rgba(120,40,100,0.15)",
                "--overlay-toolbar-fg": "#4A1942",
                "--overlay-button-hover": "rgba(255,102,170,0.1)",
                "--overlay-button-active": "rgba(255,102,170,0.18)",
                "--overlay-status-bg": "rgba(80,20,60,0.28)",
                "--overlay-status-fg": "#FFFFFF",
                "--overlay-status-sep": "rgba(255,255,255,0.32)",
                "--overlay-popup-bg": "#FFF0F6",
                "--overlay-popup-border": "rgba(255,102,170,0.14)",
                "--overlay-popup-fg": "#4A1942",
                "--overlay-page-bg": "#FFF0F6",
                "--overlay-page-border": "rgba(255,102,170,0.14)",
                "--overlay-page-fg": "#4A1942",
                "--overlay-page-hint": "rgba(74,25,66,0.55)",
                "--overlay-page-hover": "rgba(255,102,170,0.1)",
                "--overlay-page-shadow": "rgba(120,40,100,0.15)",
                "--overlay-reload-mask": "rgba(50,15,40,0.48)",
                "--overlay-reload-card": "rgba(60,20,50,0.9)",
                "--overlay-reload-text": "rgba(255,255,255,0.94)",
                "--overlay-dev-watermark": "rgba(255,255,255,0.47)",
                "--text-inverse": "#FFFFFF",
                "--ring-bg": "rgba(255,102,170,0.12)",
                "--dialog-overlay": "rgba(40,10,30,0.5)",
                "--dialog-icon-bg": "rgba(255,102,170,0.12)",
            },
            "dark": {
                "--bg-app": "#1A1030",
                "--bg-surface": "#2A1B45",
                "--bg-color": "#2A1B45",
                "--sidebar-bg": "#2A1B45",
                "--border-color": "rgba(255,136,204,0.2)",
                "--text-primary": "#FFD6EB",
                "--text-secondary": "#CC99BB",
                "--accent-blue": "#FF88CC",
                "--divider": "rgba(255,136,204,0.2)",
                "--card-bg": "rgba(255,136,204,0.12)",
                "--card-border": "rgba(255,136,204,0.2)",
                "--item-hover": "rgba(255,136,204,0.18)",
                "--shadow-color": "rgba(0,0,0,0.45)",
                "--shadow-main": "0 10px 30px var(--shadow-color)",
                "--logo-glow": "rgba(255,136,204,0.3)",
                "--hyperos-g1": "#1A1030",
                "--hyperos-g2": "#2A1B45",
                "--hyperos-g3": "#3A2B55",
                "--hyperos-g4": "#4A3B65",
                "--hyperos-g5": "#2A1B45",
                "--overlay-toolbar-bg": "#2A1B45",
                "--overlay-toolbar-border": "rgba(255,136,204,0.22)",
                "--overlay-toolbar-line": "rgba(255,136,204,0.22)",
                "--overlay-toolbar-shadow": "rgba(0,0,0,0.45)",
                "--overlay-toolbar-fg": "#FFD6EB",
                "--overlay-button-hover": "rgba(255,136,204,0.18)",
                "--overlay-button-active": "rgba(255,136,204,0.28)",
                "--overlay-status-bg": "rgba(0,0,0,0.35)",
                "--overlay-status-fg": "#FFFFFF",
                "--overlay-status-sep": "rgba(255,255,255,0.32)",
                "--overlay-popup-bg": "#2A1B45",
                "--overlay-popup-border": "rgba(255,136,204,0.25)",
                "--overlay-popup-fg": "#FFD6EB",
                "--overlay-page-bg": "#2A1B45",
                "--overlay-page-border": "rgba(255,136,204,0.25)",
                "--overlay-page-fg": "#FFD6EB",
                "--overlay-page-hint": "rgba(255,200,225,0.65)",
                "--overlay-page-hover": "rgba(255,136,204,0.18)",
                "--overlay-page-shadow": "rgba(0,0,0,0.45)",
                "--overlay-reload-mask": "rgba(0,0,0,0.55)",
                "--overlay-reload-card": "rgba(42,27,69,0.92)",
                "--overlay-reload-text": "rgba(255,255,255,0.94)",
                "--overlay-dev-watermark": "rgba(255,255,255,0.47)",
                "--text-inverse": "#1A1030",
                "--ring-bg": "rgba(255,136,204,0.18)",
                "--dialog-overlay": "rgba(0,0,0,0.65)",
                "--dialog-icon-bg": "rgba(255,136,204,0.18)",
            },
        },
        "togenashi-togeari": {
            "light": {
                ...
                "--border-color": "#85C9DC",
                "--text-primary": "#1C1412",
                "--text-secondary": "#6B4F4B",
                "--accent-blue": "#D90E2C",
                "--divider": "#E34D8D",
                "--card-bg": "#76BD53",
                "--card-border": "rgba(118,189,83,0.3)",
                "--item-hover": "rgba(217,14,44,0.08)",
                "--shadow-color": "rgba(0,0,0,0.06)",
                "--shadow-main": "0 4px 12px var(--shadow-color)",
                "--logo-glow": "rgba(217,14,44,0.15)",
                "--hyperos-g1": "#85C9DC",
                "--hyperos-g2": "#76BD53",
                "--hyperos-g3": "#E34D8D",
                "--hyperos-g4": "#EEDA01",
                ...
                "--font-weight-override": "400",
                "--overlay-toolbar-bg": "#FFFFFF",
                "--overlay-toolbar-border": "#E34D8D",
                "--overlay-toolbar-line": "rgba(227,77,141,0.3)",
                "--overlay-toolbar-shadow": "rgba(217,14,44,0.12)",
                "--overlay-toolbar-fg": "#191919",
                "--overlay-button-hover": "rgba(217,14,44,0.08)",
                "--overlay-button-active": "rgba(217,14,44,0.15)",
                "--overlay-status-bg": "#EEDA01",
                "--overlay-status-fg": "#3A3000",
                "--overlay-status-sep": "rgba(58,48,0,0.2)",
                "--overlay-popup-bg": "#FFFFFF",
                "--overlay-popup-border": "#EEDA01",
                "--overlay-popup-fg": "#191919",
                "--overlay-page-bg": "#FFFFFF",
                "--overlay-page-border": "#85C9DC",
                "--overlay-page-fg": "#191919",
                "--overlay-page-hint": "rgba(0,0,0,0.5)",
                "--overlay-page-hover": "rgba(133,201,220,0.15)",
                "--overlay-page-shadow": "rgba(0,0,0,0.15)",
                "--overlay-reload-mask": "rgba(0,0,0,0.43)",
                "--overlay-reload-card": "rgba(30,30,30,0.86)",
                "--overlay-reload-text": "rgba(255,255,255,0.92)",
                "--overlay-dev-watermark": "rgba(255,255,255,0.47)",
                "--text-inverse": "#FFFFFF",
                "--ring-bg": "rgba(217,14,44,0.08)",
                "--dialog-overlay": "rgba(0,0,0,0.4)",
                "--dialog-icon-bg": "#FFF2F2",
            },
            "dark": {
                "--bg-app": "#140A08",
                "--bg-surface": "#1C1210",
                ...
                "--card-bg": "#5A9A48",
                "--card-border": "rgba(118,189,83,0.3)",
                "--item-hover": "rgba(255,90,74,0.15)",
                "--shadow-color": "rgba(0,0,0,0.35)",
                "--shadow-main": "0 8px 32px var(--shadow-color)",
                "--logo-glow": "rgba(255,90,74,0.25)",
                "--hyperos-g1": "#1A2D30",
                "--hyperos-g2": "#1A2D14",
                "--hyperos-g3": "#2D1420",
                "--hyperos-g4": "#2D2A10",
                "--hyperos-g5": "#2D1010",
                "--overlay-toolbar-bg": "#1C1210",
                "--overlay-toolbar-border": "#C0607A",
                "--overlay-toolbar-line": "rgba(227,77,141,0.2)",
                "--overlay-toolbar-shadow": "rgba(0,0,0,0.35)",
                "--overlay-toolbar-fg": "#F0E8E5",
                "--overlay-button-hover": "rgba(255,90,74,0.15)",
                "--overlay-button-active": "rgba(255,90,74,0.25)",
                "--overlay-status-bg": "#B8A800",
                "--overlay-status-fg": "#FFFDE0",
                "--overlay-status-sep": "rgba(255,253,224,0.25)",
                "--overlay-popup-bg": "#1C1210",
                "--overlay-popup-border": "#B8A800",
                "--overlay-popup-fg": "#F0E8E5",
                "--overlay-page-bg": "#1C1210",
                "--overlay-page-border": "#5BA0B0",
                "--overlay-page-fg": "#F0E8E5",
                "--overlay-page-hint": "rgba(255,255,255,0.6)",
                "--overlay-page-hover": "rgba(91,160,176,0.15)",
                "--overlay-page-shadow": "rgba(0,0,0,0.35)",
                "--overlay-reload-mask": "rgba(0,0,0,0.48)",
                "--overlay-reload-card": "rgba(30,18,16,0.92)",
                "--overlay-reload-text": "rgba(255,255,255,0.94)",
                "--overlay-dev-watermark": "rgba(255,255,255,0.47)",
                "--text-inverse": "#0A0504",
                "--ring-bg": "rgba(255,90,74,0.15)",
                "--dialog-overlay": "rgba(0,0,0,0.65)",
                "--dialog-icon-bg": "rgba(255,90,74,0.15)",
            },
        },
    }
